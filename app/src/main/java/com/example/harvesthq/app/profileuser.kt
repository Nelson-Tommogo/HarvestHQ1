...
//
//@Composable
//fun DemoComposeTheme(content: @Composable () -> Unit) {
...
//            ) {
//                ProfileInfoSection("Pankti Prajapati")
//                Button(
//                    modifier = Modifier.padding(vertical = 8.dp),
//                    onClick = { showPortfolio.value = !showPortfolio.value }
//                ) {
//                    Text(text = "Portfolio")
//                }
//            }
...
//    ) {
//        ProfileList(listOf("Hema", "Shushma", "Jaya", "Rekha", "Vijya", "Sabki pasand Nirma"))
//    }
//}
//
//@Composable
...
//                    .size(35.dp)
//            )
//            ProfileInfoSection(modifier = Modifier.padding(start = 8.dp))
//        }
//    }
//}
//
...
//@Composable
//fun ProfileInfoSection(modifier: Modifier) {
//    Column(horizontalAlignment = Alignment.Start, modifier = modifier) {
//        Text(
//            text = name,
//            style = TextStyle(color = Color.Blue, fontFamily = FontFamily.SansSerif, fontSize = 20.sp)
//        )
//        Text(
